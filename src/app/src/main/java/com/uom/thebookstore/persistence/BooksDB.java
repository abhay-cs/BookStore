...
public class BooksDB
{
    ...
    public boolean CreateDB() {
        ...
        String createBooks = "CREATE TABLE IF NOT EXISTS " + TABLE1 + " (" + BID + " INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " + BNAME + " VARCHAR(50), " + BAUTHOR + " VARCHAR(50), " + BPRICE + " double, " + BDESCRIPTION + " VARCHAR(5000), " + BGENRE + " VARCHAR(50))";
